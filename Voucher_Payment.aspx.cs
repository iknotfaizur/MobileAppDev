...
namespace SMS
{
    public partial class Voucher_Payment : System.Web.UI.Page
    {
        BEL bel = new BEL();
        BLL bal = new BLL();
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txt_Debit_Code.Text = (row.FindControl("lbl_GL_Code") as Label).Text;
            txt_Debit_Acc_Name.Text = (row.FindControl("lbl_GL_Name") as Label).Text;
            mp1.Hide();
        ...
        {
            bel.Search = txt_Debit_Code.Text;
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    bool status1 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, txt_Debit_Code.Text, txt_Transaction_Amount.Text, Dr, "GL", Transaction_Particulars, txt_Narration.Text, "VP");

                    // Credit Account

                    bool status2 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, txt_Credit_Code.Text, txt_Transaction_Amount.Text, Cr, "GL", Transaction_Particulars, txt_Narration.Text, "VP");
