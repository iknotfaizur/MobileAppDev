<%@ Page Title="Unit Master" Language="C#" MasterPageFile="~/Main_Master.Master" AutoEventWireup="true" CodeBehind="Unit_Master.aspx.cs" Inherits="SMS.Unit_Master" %>
 <%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head_Content" runat="server">
<script type="text/javascript">
    window.onload = function () {
        document.getElementById('<%= txt_Unit_Name.ClientID%>').focus();
    };
</script>
<style>
.mydatagrid
...
<td>
    <asp:TextBox ID="txt_Unit_Name" runat="server"></asp:TextBox>
...
<tr>
                ...
                <ItemTemplate>  
                <asp:Label ID="lbl_Unit_Name" runat="server" Font-Bold Text='<%#Bind("Unit_Name") %>'></asp:Label>  
                </ItemTemplate>  
                </asp:TemplateField>
