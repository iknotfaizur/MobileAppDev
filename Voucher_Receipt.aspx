<%@ Page Title="Voucher Receipt" Language="C#" MasterPageFile="~/Purchase_Sales_Menu.Master" AutoEventWireup="true" CodeBehind="Voucher_Receipt.aspx.cs" Inherits="SMS.Voucher_Receipt" %>
...
<td>
    <asp:TextBox ID="txt_Debit_Code" runat="server" Text="29000" Enabled="false"></asp:TextBox>
</td>
<td>
 Account Name
</td>
<td>
    <asp:TextBox ID="txt_Debit_Acc_Name" runat="server" Text="Cash" Enabled="false"></asp:TextBox>
</td>
</tr>
<tr style="height:40px">
<td>
...
<td>
    <asp:TextBox ID="txt_Credit_Code" runat="server"></asp:TextBox>
</td>
<td>
 Account Name
</td>
<td>
    <asp:TextBox ID="txt_Credit_Acc_Name" runat="server"></asp:TextBox>
</td>
<td align="left">
