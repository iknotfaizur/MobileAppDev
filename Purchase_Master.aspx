<%@ Page Title="Purchase Master" Language="C#" MasterPageFile="~/Purchase_Sales.Master" AutoEventWireup="true" CodeBehind="Purchase_Master.aspx.cs" Inherits="SMS.Purchase_Master" %>
...
<ContentTemplate>
    ...
    <hr>
        ...
        <tr style="height: 30px">
            ...
            <td>
                <asp:TextBox ID="txt_Receipt_No" Font-Bold runat="server" Width="100px"></asp:TextBox>
            ...
            <td>
                <asp:TextBox ID="txt_Supplier_Id" Font-Bold runat="server" Enabled="false" Width="100px"></asp:TextBox>
            </td>
            <td>
                <b>Supplier Name</b>
            </td>
            <td>
                <asp:TextBox ID="txt_Supplier_Name" Font-Bold runat="server" Width="300px"></asp:TextBox> 
            </td>
            <td align="left">
...
MinimumPrefixLength="1" EnableCaching="true" CompletionSetCount="1" CompletionInterval="1000" ServiceMethod="GetCountries" >
            ...
            <td>
                <asp:TextBox ID="txt_Rate" runat="server" Font-Bold Width="100px" OnTextChanged="txt_Rate_Change" AutoPostBack="true"  OnClientClick = "return false;"></asp:TextBox>
            </td>
            <td>
...
<asp:GridView ID="GridView2" CssClass="mydatagrid" PagerStyle-CssClass="pager" HeaderStyle-CssClass="header" RowStyle-CssClass="rows" runat="server"  AllowPaging="true" PageSize="500" AutoGenerateColumns="False" OnRowDeleting="GridView2_RowDeleting" OnRowDataBound="GridView2_RowDataBound">  
    ...
    <td align="right">
            ...
            <td>
                <asp:TextBox ID="txt_Purchase_Value" runat="server" Text="0.00" Style="text-align: right;
     ...
     <td align="right">
        ...
        <tr>
           <td align="right">
            ...
            <td>
                <asp:TextBox ID="txt_Invoice_No" runat="server" Style="text-align: right;
                    color: blue" Font-Bold Width="120px" Enabled="false"></asp:TextBox>
            </td>
             <td align="right">
                <b>Tran. Id</b>
