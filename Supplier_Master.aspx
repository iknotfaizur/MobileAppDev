<%@ Page Title="Supplier Master" Language="C#" MasterPageFile="~/Main_Master.Master" AutoEventWireup="true" CodeBehind="Supplier_Master.aspx.cs" Inherits="SMS.Supplier_Master" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head_Content" runat="server">
<script type="text/javascript">
    window.onload = function () {
        document.getElementById('<%= txt_Supplier_Name.ClientID%>').focus();
    };
</script>
<script type = "text/javascript">
    function Confirm() {
...
<td>
    <asp:TextBox ID="txt_Supplier_Name" runat="server"></asp:TextBox>
</td>
</tr>
<tr style="height:40px">
<td>
...
<td colspan="3">
    <asp:TextBox ID="txt_Address_Line1" runat="server" Width="568px"></asp:TextBox>
</td>
</tr>
<tr style="height:40px">
<td>
...
<td colspan="3">
    <asp:TextBox ID="txt_Address_Line2" runat="server" Width="568px"></asp:TextBox>
</td>
</tr>
<tr style="height:40px">
<td>
...
<td colspan="3">
    <asp:TextBox ID="txt_Gst_Tin_No" runat="server" Width="568px"></asp:TextBox>
</td>
</tr>
<tr style="height:40px">
<td>
...
<td colspan="3">
    <asp:TextBox ID="txt_Remarks" runat="server" Width="568px"></asp:TextBox>
</td>
</tr>
<tr style="height:40px">
<td align="right">
