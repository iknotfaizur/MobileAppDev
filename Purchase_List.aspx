<%@ Page Title="Purchase List" Language="C#" MasterPageFile="~/Purchase_Sales_Menu.Master" AutoEventWireup="true" CodeBehind="Purchase_List.aspx.cs" Inherits="SMS.Purchase_List" %>
...
<tr>
                ...
                <ItemTemplate>  
                <asp:Label ID="lbl_Account_No" runat="server" Font-Bold Text='<%#Bind("Invoice_No") %>'></asp:Label>  
                </ItemTemplate>  
                </asp:TemplateField>
