    ...
    public partial class Sales_Master : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    txt_Account_No.Text = Session["Account_No"].ToString();
                ...
                else
                {
                    ...
                    txt_Invoice_No.Text = bal.Get_Sales_Invoice_No(lbl_Current_Date.Text).Tables[0].Rows[0][0].ToString();
                    txt_Account_No.Text = bal.Get_Sales_Acc_No(bel).Tables[0].Rows[0][0].ToString();
        ...
        {
            bel.Search = txt_Customer_Name.Text;
        ...
        protected void OnSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            txt_Customer_Id.Text = (row.FindControl("lbl_Customer_Id") as Label).Text;
            txt_Customer_Name.Text = (row.FindControl("lbl_Customer_Name") as Label).Text;
            mp1.Hide();
        ...
        protected void btn_Save_Click(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Choose Customer Name!!')", true);
                SetFocus(txt_Customer_Id);
            }
            else if (txt_Customer_Name.Text == "")
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Choose Customer Name!!')", true);
                SetFocus(txt_Customer_Name.Text);
            }
            else if (Convert.ToDecimal(txt_Sales_Value.Text) <= 0)
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Enter Sales Product!!')", true);
                SetFocus(txt_Product_Code);
            }
            ...
            else
            {
                try
                {
                    ...
                    bel.Supplier_Id = txt_Customer_Id.Text;
                    bel.Supplier_Name = txt_Customer_Name.Text;
                    bel.Scheme_Code = hd_Scheme_Code.Value;
                    bel.Sales_Value = txt_Sales_Value.Text;
                    ...
                    bool status1 = bal.Save_Sales_Invoice(bel);
                    ...
                    for (int i = 0; i <= GridView2.Rows.Count - 1; i++)
                    {
                        ...
                        bool status2 = bal.Save_Sales_Details(txt_Invoice_No.Text,txt_Invoice_Date.Text, txt_Account_No.Text, Code, Product_Name, Unit_Name, Quantity, Rate, Amount, CGST_PER, CGST_AMT, SGST_PER, SGST_AMT, IGST_PER, IGST_AMT);
                    }

                    string Cr = "Credit";
                    string Dr = "Debit";
                    string Transaction_Particulars = "Sales Invoice" + " - " + txt_Account_No.Text + " - " + txt_Customer_Name.Text + " - Rs " + txt_Grand_Total.Text;
                    ...
                    if (ddl_Payment_Mode.Text == "Cash")
                    {
                        ...
                        bool status3 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, "39001", txt_Sales_Value.Text, Cr, "GL", Transaction_Particulars, txt_Narration.Text, "SM");

                        // Cash Head

                        bool status4 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, "29000", txt_Grand_Total.Text, Dr, "GL", Transaction_Particulars, txt_Narration.Text, "SM");
                    ...
                    else
                    {
                        ...
                        bool status5 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, "39001", txt_Sales_Value.Text, Cr, "GL", Transaction_Particulars, txt_Narration.Text, "SM");

                        // Purchase Amount Payable

                        bool status6 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, "39002", txt_Grand_Total.Text, Dr, "GL", Transaction_Particulars, txt_Narration.Text, "SM");
                    ...
                    bool status10 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, "39003", txt_Addition.Text, Cr, "GL", Transaction_Particulars, txt_Narration.Text, "SM");

                    // Purchase Deduction

                    bool status11 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, "39004", txt_Deduction.Text, Dr, "GL", Transaction_Particulars, txt_Narration.Text, "SM");
                    ...
                    bool status7 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, "40001", CGST_AMT2.ToString(), Cr, "GL", Transaction_Particulars, txt_Narration.Text, "SM");

                    // SGST Taxable

                    bool status8 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, "40002", SGST_AMT2.ToString(), Cr, "GL", Transaction_Particulars, txt_Narration.Text, "SM");

                    // IGST Taxable

                    bool status9 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, "40003", IGST_AMT2.ToString(), Cr, "GL", Transaction_Particulars, txt_Narration.Text, "SM");
                    ...
                    if (ddl_Payment_Mode.Text == "Cash")
                    {
                        ...
                        bool status12 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, txt_Account_No.Text, txt_Grand_Total.Text, Cr, "AC", Transaction_Particulars, txt_Narration.Text, "SM");

                        // Debit

                        bool status13 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, txt_Account_No.Text, txt_Grand_Total.Text, Dr, "AC", Transaction_Particulars, txt_Narration.Text, "SM");

                        // Customer Account
                        
                        // Credit

                        bool status14 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, txt_Customer_Id.Text, txt_Grand_Total.Text, Cr, "IAC", Transaction_Particulars, txt_Narration.Text, "SM");

                        // Debit

                        bool status15 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, txt_Customer_Id.Text, txt_Grand_Total.Text, Dr, "IAC", Transaction_Particulars, txt_Narration.Text, "SM");
                    ...
                    else
                    {
                        ...
                        bool status16 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, txt_Account_No.Text, txt_Grand_Total.Text, Dr, "AC", Transaction_Particulars, txt_Narration.Text, "SM");

                        // Customer Account

                        // Credit

                        bool status17 = bal.Save_Daily_Transaction(txt_Transaction_Id.Text, txt_Transaction_Date.Text, txt_Customer_Id.Text, txt_Grand_Total.Text, Cr, "IAC", Transaction_Particulars, txt_Narration.Text, "SM");

                    }

                    // Save Cust Acc Link

                    bool status18 = bal.Save_Cust_Acc_Link(txt_Account_No.Text, txt_Customer_Id.Text, txt_Customer_Name.Text, "Sales");

                    // Update Closing Balance

                    bool status19 = bal.Update_Closing_Balance(txt_Account_No.Text);
        ...
        protected void txt_Product_Code_Change(object sender, EventArgs e)
        {
            if (txt_Customer_Id.Text == "")
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Choose Customer!!')", true);
                SetFocus(txt_Customer_Name);
        ...
        void Fetch_Product_Details()
        {
            ...
            if (bel.Product_Name != "")
            {
                ...
                txt_Rate.Text = bel.Sales_Price.ToString();
        ...
        protected void txt_Rate_Change(object sender, EventArgs e)
        {
            ...
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "alertMessage", "alert('Enter Sales Rate!!')", true);
                txt_Rate.Text = "";
                SetFocus(txt_Product_Code);
            }
            else
        ...
        protected void GridView2_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            txt_Sales_Value.Text = dt.AsEnumerable().Sum(x => Convert.ToDecimal(x["Amount"])).ToString("N");
            ...
            if (!string.IsNullOrEmpty(txt_Sales_Value.Text) && !string.IsNullOrEmpty(txt_Total_Tax.Text) && !string.IsNullOrEmpty(txt_Addition.Text) && !string.IsNullOrEmpty(txt_Deduction.Text) && !string.IsNullOrEmpty(txt_Grand_Total.Text))

                lbl_Balance.Text = txt_Closing_Balance.Text = txt_Grand_Total.Text = (Convert.ToDecimal(txt_Sales_Value.Text) + Convert.ToDecimal(txt_Total_Tax.Text) + Convert.ToDecimal(txt_Addition.Text) - Convert.ToDecimal(txt_Deduction.Text)).ToString("N");
        ...
        protected void txt_Grand_Total_Change(object sender, EventArgs e)
        {
            if (!string.IsNullOrEmpty(txt_Sales_Value.Text) && !string.IsNullOrEmpty(txt_Total_Tax.Text) && !string.IsNullOrEmpty(txt_Addition.Text) && !string.IsNullOrEmpty(txt_Deduction.Text) && !string.IsNullOrEmpty(txt_Grand_Total.Text))
                ...
                txt_Grand_Total.Text = (Convert.ToDecimal(txt_Sales_Value.Text) + Convert.ToDecimal(txt_Total_Tax.Text) + Convert.ToDecimal(txt_Addition.Text) - Convert.ToDecimal(txt_Deduction.Text)).ToString("N");
        ...
        void Fetch_Purchase_Details()
        {
            ...
            txt_Customer_Id.Text = bel.Supplier_Id;
            txt_Customer_Name.Text = bel.Supplier_Name ;
            hd_Scheme_Code.Value = bel.Scheme_Code;
            txt_Sales_Value.Text = bel.Purchase_Value;
            ...
            txt_Account_No.Text = bel.Account_No;
